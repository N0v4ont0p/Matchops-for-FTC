...
const en: Dict = {
  ...
  season: "Season",
  teamLookup: "Team lookup",
  teamNumber: "Team number",
  lookupTeam: "Lookup team",
  noTeamFound: "Team not found",
  teamNotFound: "No team found for this number",
  eventInfo: "Event info",
  apiError: "Unable to load FTCScout data right now.",
  loading: "Loading",
  noData: "No data yet",
...
const zh: Dict = {
  ...
  lookupTeam: "查询队伍",
  noTeamFound: "未找到队伍",
  teamNotFound: "未查询到该编号的队伍",
  eventInfo: "赛事信息",
  apiError: "当前无法加载 FTCScout 数据。",
  loading: "加载中",
  noData: "暂无数据",
